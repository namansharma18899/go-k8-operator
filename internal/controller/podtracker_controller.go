...
// +kubebuilder:rbac:groups=crd,resources=podtrackers,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=crd,resources=podtrackers/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=crd,resources=podtrackers/finalizers,verbs=update
...
func (r *PodTrackerReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	logger.Info("PodTracker Ctrl triggered")
...
// SetupWithManager sets up the controllerod{} with the Manager.
